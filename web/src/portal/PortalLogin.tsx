 ...
 *
 * This list held three real customer logins, password included, rendered into
 * a public page. Customers sign in with their own credentials; the main
 * sign-in form also routes portal accounts here automatically, so a shortcut
 * list is not needed to reach this screen.
 */
