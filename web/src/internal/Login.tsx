      ...
      <main className="relative z-10 w-full max-w-[420px] mx-auto my-auto pt-14 sm:pt-0">
        ...
        >
          ...
          >
            ...
            <motion.div variants={itemVariants} className="relative flex py-3.5 items-center">
              <div className="flex-grow border-t border-slate-200"></div>
              <span className="flex-shrink mx-2.5 text-[10px] text-slate-400">
                or continue with
              </span>
              <div className="flex-grow border-t border-slate-200"></div>
            </motion.div>

            {/* Social / SSO Stack with Hover & Tap Animations */}
            <motion.div variants={itemVariants} className="space-y-2">
              ...
              <motion.button
                ...
                transition={{ duration: 0.15 }}
                onClick={() => showDemoNotice("Google SSO is configured for enterprise domains.")}
                className="w-full flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-700 rounded-lg text-xs font-medium transition-colors shadow-2xs cursor-pointer"
              >
              ...
              <motion.button
                ...
                whileTap={shouldReduceMotion ? {} : { scale: 0.99 }}
                transition={{ duration: 0.15 }}
                onClick={() => showDemoNotice("SAML / Okta authentication is active for verified organizations.")}
                className="w-full flex items-center justify-center gap-2 py-2 px-3 border border-slate-200 hover:border-slate-300 bg-white hover:bg-slate-50 text-slate-700 rounded-lg text-xs font-medium transition-colors shadow-2xs cursor-pointer"
              >
                <svg className="w-3.5 h-3.5 text-[#3b5bf6]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
